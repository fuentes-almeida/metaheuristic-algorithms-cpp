...
public:
	...
	virtual void setSharedParameters(map<string, double> &p){ sharedParameters = p; }
	virtual void setSharedParametersPointers(map<string, void*> &p){ sharedParametersPointers = p; }
	...
	map<string, double> getSharedParameters() { return sharedParameters; }
	map<string, void*> getSharedParametersPointers() { return sharedParametersPointers; }

	// Soporte de multiObjectivizacion
	virtual bool supportsMultiObjectivization() { return false; }

	void resetNumImprovements(){ numImprovements = 0; }
	int getNumImprovements() { return numImprovements; }

protected:
	int numImprovements;
	vector<Individual*>* population;
	map<string, double> sharedParameters;
	map<string, void* > sharedParametersPointers;
